...
def welcome(lang="ru"):
    if _is_en(lang):
        return (
            ...
            "⚡️ Up to 500 Mbps · zero throttling\n"
            "🔓 Bypasses all blocklists — works even where others fail\n"
            "🌐 Hand-picked servers across dozens of countries\n"
            ...
            "✅ <b>Servers always in stock.</b> "
            "After payment your config lands in the app instantly — just connect and go.\n"
            f"{LINE}\n"
            "Choose an action 👇"
        )
    return (
        ...
        "⚡️ До 500 Мбит/с · без ограничений скорости\n"
        "🔓 Обходит белые списки — работает там, где другие сдаются\n"
        ...
        "✅ <b>Серверы всегда в наличии.</b> "
        "После оплаты конфиг мгновенно появляется в приложении — просто подключайся.\n"
        f"{LINE}\n"
        "Выбери действие 👇"
    )
...
def faq(lang="ru"):
    if _is_en(lang):
        return (
            ...
            "<b>How fast is it?</b>\n"
            "Up to 500 Mbps depending on the plan — enough for 4K, calls and gaming.\n\n"
    ...
    return (
        ...
        "<b>Какая скорость?</b>\n"
        "До 500 Мбит/с в зависимости от тарифа — хватает на 4K, звонки и игры.\n\n"
...
def prime_card(price, devices, period, lang="ru", usd_rate=None):
    ...
    if _is_en(lang):
        return (
            ...
            "⚡️ Max speed & priority (up to 500 Mbps)\n"
    ...
    return (
        ...
        "⚡️ Максимальная скорость и приоритет (до 500 Мбит/с)\n"
